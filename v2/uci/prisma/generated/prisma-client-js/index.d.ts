  ...
  */
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof AdapterCountOutputType
            ? AdapterCountOutputType[P]
            : never;
        }
      : AdapterCountOutputType
    : AdapterCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof ServiceCountOutputType
            ? ServiceCountOutputType[P]
            : never;
        }
      : ServiceCountOutputType
    : ServiceCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      ? {
          [P in TrueKeys<
            S['select']
          >]: P extends keyof TransformerCountOutputType
            ? TransformerCountOutputType[P]
            : never;
        }
      : TransformerCountOutputType
    : TransformerCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof BotCountOutputType
            ? BotCountOutputType[P]
            : never;
        }
      : BotCountOutputType
    : BotCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      ? {
          [P in TrueKeys<
            S['select']
          >]: P extends keyof UserSegmentCountOutputType
            ? UserSegmentCountOutputType[P]
            : never;
        }
      : UserSegmentCountOutputType
    : UserSegmentCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      ? {
          [P in TrueKeys<
            S['select']
          >]: P extends keyof ConversationLogicCountOutputType
            ? ConversationLogicCountOutputType[P]
            : never;
        }
      : ConversationLogicCountOutputType
    : ConversationLogicCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? Adapter & {
          [P in TrueKeys<S['include']>]: P extends 'ConversationLogic'
            ? Array<ConversationLogicGetPayload<S['include'][P]>>
            : P extends '_count'
            ? AdapterCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'ConversationLogic'
            ? Array<ConversationLogicGetPayload<S['select'][P]>>
            : P extends '_count'
            ? AdapterCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof Adapter
            ? Adapter[P]
            : never;
        }
      : Adapter
  ...
  export interface AdapterDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends AdapterFindUniqueArgs,
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__AdapterClient<Adapter>,
          Prisma__AdapterClient<AdapterGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__AdapterClient<Adapter | null>,
          Prisma__AdapterClient<AdapterGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends AdapterFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    findMany<T extends AdapterFindManyArgs>(
      ...
      T,
      PrismaPromise<Array<Adapter>>,
      PrismaPromise<Array<AdapterGetPayload<T>>>
    >;
     ...
     * })
     **/
    aggregate<T extends AdapterAggregateArgs>(
      args: Subset<T, AdapterAggregateArgs>,
    ): PrismaPromise<GetAdapterAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, AdapterGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
      ? GetAdapterGroupByPayload<T>
  ...
  export class Prisma__AdapterClient<T> implements PrismaPromise<T> {
    ...
    ConversationLogic<T extends ConversationLogicFindManyArgs = {}>(
      args?: Subset<T, ConversationLogicFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<ConversationLogic>>,
      PrismaPromise<Array<ConversationLogicGetPayload<T>>>
    >;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof Board
            ? Board[P]
            : never;
        }
      : Board
  ...
  export interface BoardDelegate<GlobalRejectSettings> {
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__BoardClient<Board>,
          Prisma__BoardClient<BoardGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__BoardClient<Board | null>,
          Prisma__BoardClient<BoardGetPayload<T> | null>
        >;
    ...
    ): PrismaPromise<GetBoardAggregateType<T>>;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? Service & {
          [P in TrueKeys<S['include']>]: P extends 'Transformer'
            ? Array<TransformerGetPayload<S['include'][P]>>
            : P extends 'UserSegmentByID'
            ? Array<UserSegmentGetPayload<S['include'][P]>>
            : P extends 'UserSegmentByPhone'
            ? Array<UserSegmentGetPayload<S['include'][P]>>
            : P extends 'UserSegmentAll'
            ? Array<UserSegmentGetPayload<S['include'][P]>>
            : P extends '_count'
            ? ServiceCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'Transformer'
            ? Array<TransformerGetPayload<S['select'][P]>>
            : P extends 'UserSegmentByID'
            ? Array<UserSegmentGetPayload<S['select'][P]>>
            : P extends 'UserSegmentByPhone'
            ? Array<UserSegmentGetPayload<S['select'][P]>>
            : P extends 'UserSegmentAll'
            ? Array<UserSegmentGetPayload<S['select'][P]>>
            : P extends '_count'
            ? ServiceCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof Service
            ? Service[P]
            : never;
        }
      : Service
  ...
  export interface ServiceDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends ServiceFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__ServiceClient<Service>,
          Prisma__ServiceClient<ServiceGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__ServiceClient<Service | null>,
          Prisma__ServiceClient<ServiceGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends ServiceFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    findMany<T extends ServiceFindManyArgs>(
      ...
      T,
      PrismaPromise<Array<Service>>,
      PrismaPromise<Array<ServiceGetPayload<T>>>
    >;
    ...
    ): PrismaPromise<GetServiceAggregateType<T>>;
  ...
  export class Prisma__ServiceClient<T> implements PrismaPromise<T> {
    ...
    Transformer<T extends TransformerFindManyArgs = {}>(
      args?: Subset<T, TransformerFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<Transformer>>,
      PrismaPromise<Array<TransformerGetPayload<T>>>
    >;

    UserSegmentByID<T extends UserSegmentFindManyArgs = {}>(
      args?: Subset<T, UserSegmentFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<UserSegment>>,
      PrismaPromise<Array<UserSegmentGetPayload<T>>>
    >;

    UserSegmentByPhone<T extends UserSegmentFindManyArgs = {}>(
      args?: Subset<T, UserSegmentFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<UserSegment>>,
    ...
    UserSegmentAll<T extends UserSegmentFindManyArgs = {}>(
      args?: Subset<T, UserSegmentFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<UserSegment>>,
  ...
  type GetTransformerGroupByPayload<T extends TransformerGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<TransformerGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof TransformerGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? Transformer & {
          [P in TrueKeys<S['include']>]: P extends 'service'
            ? ServiceGetPayload<S['include'][P]>
            : P extends 'TranformerConfig'
            ? Array<TransformerConfigGetPayload<S['include'][P]>>
            : P extends '_count'
            ? TransformerCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'service'
            ? ServiceGetPayload<S['select'][P]>
            : P extends 'TranformerConfig'
            ? Array<TransformerConfigGetPayload<S['select'][P]>>
            : P extends '_count'
            ? TransformerCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof Transformer
            ? Transformer[P]
            : never;
        }
      : Transformer
  ...
  export interface TransformerDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends TransformerFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__TransformerClient<Transformer>,
          Prisma__TransformerClient<TransformerGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__TransformerClient<Transformer | null>,
          Prisma__TransformerClient<TransformerGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends TransformerFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends TransformerAggregateArgs>(
      args: Subset<T, TransformerAggregateArgs>,
    ): PrismaPromise<GetTransformerAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, TransformerGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetTransformerGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
  ...
  export class Prisma__TransformerClient<T> implements PrismaPromise<T> {
    ...
    service<T extends ServiceArgs = {}>(
      args?: Subset<T, ServiceArgs>,
    ): CheckSelect<
      T,
      Prisma__ServiceClient<Service | null>,
      Prisma__ServiceClient<ServiceGetPayload<T> | null>
    ...
    TranformerConfig<T extends TransformerConfigFindManyArgs = {}>(
      args?: Subset<T, TransformerConfigFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<TransformerConfig>>,
      PrismaPromise<Array<TransformerConfigGetPayload<T>>>
    >;
  ...
  export type TransformerUpdateManyArgs = {
     ...
     **/
    data: XOR<
      TransformerUpdateManyMutationInput,
      TransformerUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetTransformerConfigAggregateType<
    T extends TransformerConfigAggregateArgs,
  > = {
    [P in keyof T & keyof AggregateTransformerConfig]: P extends
      | '_count'
      | 'count'
      ? T[P] extends true
        ? number
  ...
  type GetTransformerConfigGroupByPayload<
    T extends TransformerConfigGroupByArgs,
  > = PrismaPromise<
    Array<
      PickArray<TransformerConfigGroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof TransformerConfigGroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? TransformerConfig & {
          [P in TrueKeys<S['include']>]: P extends 'transformer'
            ? TransformerGetPayload<S['include'][P]>
            : P extends 'ConversationLogic'
            ? ConversationLogicGetPayload<S['include'][P]> | null
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'transformer'
            ? TransformerGetPayload<S['select'][P]>
            : P extends 'ConversationLogic'
            ? ConversationLogicGetPayload<S['select'][P]> | null
            : P extends keyof TransformerConfig
            ? TransformerConfig[P]
            : never;
        }
      : TransformerConfig
  ...
  export interface TransformerConfigDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends TransformerConfigFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__TransformerConfigClient<TransformerConfig>,
          Prisma__TransformerConfigClient<TransformerConfigGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__TransformerConfigClient<TransformerConfig | null>,
          Prisma__TransformerConfigClient<TransformerConfigGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends TransformerConfigFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    count<T extends TransformerConfigCountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ...
          : GetScalarType<
              T['select'],
              TransformerConfigCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends TransformerConfigAggregateArgs>(
      args: Subset<T, TransformerConfigAggregateArgs>,
    ): PrismaPromise<GetTransformerConfigAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, TransformerConfigGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetTransformerConfigGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
  ...
  export class Prisma__TransformerConfigClient<T> implements PrismaPromise<T> {
    ...
    transformer<T extends TransformerArgs = {}>(
      args?: Subset<T, TransformerArgs>,
    ): CheckSelect<
      T,
      Prisma__TransformerClient<Transformer | null>,
      Prisma__TransformerClient<TransformerGetPayload<T> | null>
    ...
    ConversationLogic<T extends ConversationLogicArgs = {}>(
      args?: Subset<T, ConversationLogicArgs>,
    ): CheckSelect<
      T,
      Prisma__ConversationLogicClient<ConversationLogic | null>,
      Prisma__ConversationLogicClient<ConversationLogicGetPayload<T> | null>
    >;
  ...
  export type TransformerConfigCreateArgs = {
     ...
     **/
    data: XOR<
      TransformerConfigCreateInput,
      TransformerConfigUncheckedCreateInput
    >;
  };
  ...
  export type TransformerConfigUpdateArgs = {
     ...
     **/
    data: XOR<
      TransformerConfigUpdateInput,
      TransformerConfigUncheckedUpdateInput
    >;
    /**
  ...
  export type TransformerConfigUpdateManyArgs = {
     ...
     **/
    data: XOR<
      TransformerConfigUpdateManyMutationInput,
      TransformerConfigUncheckedUpdateManyInput
    >;
    /**
    ...
    ? 'include' extends U
      ? Bot & {
          [P in TrueKeys<S['include']>]: P extends 'users'
            ...
            ? Array<ConversationLogicGetPayload<S['include'][P]>>
            : P extends '_count'
            ? BotCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'users'
            ? Array<UserSegmentGetPayload<S['select'][P]>>
            : P extends 'logicIDs'
            ? Array<ConversationLogicGetPayload<S['select'][P]>>
            : P extends '_count'
            ? BotCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof Bot
            ? Bot[P]
            : never;
        }
  ...
  export interface BotDelegate<GlobalRejectSettings> {
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__BotClient<Bot>,
          Prisma__BotClient<BotGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__BotClient<Bot | null>,
          Prisma__BotClient<BotGetPayload<T> | null>
        >;
    ...
    findMany<T extends BotFindManyArgs>(
      ...
      T,
      PrismaPromise<Array<Bot>>,
      PrismaPromise<Array<BotGetPayload<T>>>
    >;
    ...
    ): PrismaPromise<GetBotAggregateType<T>>;
  ...
  export class Prisma__BotClient<T> implements PrismaPromise<T> {
    ...
    users<T extends UserSegmentFindManyArgs = {}>(
      args?: Subset<T, UserSegmentFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<UserSegment>>,
    ...
    logicIDs<T extends ConversationLogicFindManyArgs = {}>(
      args?: Subset<T, ConversationLogicFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<ConversationLogic>>,
  ...
  type GetUserSegmentGroupByPayload<T extends UserSegmentGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<UserSegmentGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof UserSegmentGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? UserSegment & {
          [P in TrueKeys<S['include']>]: P extends 'all'
            ? ServiceGetPayload<S['include'][P]> | null
            : P extends 'byID'
            ? ServiceGetPayload<S['include'][P]> | null
            : P extends 'byPhone'
            ? ServiceGetPayload<S['include'][P]> | null
            ...
            : P extends '_count'
            ? UserSegmentCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'all'
            ? ServiceGetPayload<S['select'][P]> | null
            : P extends 'byID'
            ? ServiceGetPayload<S['select'][P]> | null
            : P extends 'byPhone'
            ? ServiceGetPayload<S['select'][P]> | null
            ...
            : P extends '_count'
            ? UserSegmentCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof UserSegment
            ? UserSegment[P]
            : never;
        }
      : UserSegment
  ...
  export interface UserSegmentDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends UserSegmentFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__UserSegmentClient<UserSegment>,
          Prisma__UserSegmentClient<UserSegmentGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__UserSegmentClient<UserSegment | null>,
          Prisma__UserSegmentClient<UserSegmentGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends UserSegmentFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends UserSegmentAggregateArgs>(
      args: Subset<T, UserSegmentAggregateArgs>,
    ): PrismaPromise<GetUserSegmentAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, UserSegmentGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetUserSegmentGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
  ...
  export class Prisma__UserSegmentClient<T> implements PrismaPromise<T> {
    ...
    bots<T extends BotFindManyArgs = {}>(
      args?: Subset<T, BotFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<Bot>>,
      PrismaPromise<Array<BotGetPayload<T>>>
  ...
  export type UserSegmentUpdateManyArgs = {
     ...
     **/
    data: XOR<
      UserSegmentUpdateManyMutationInput,
      UserSegmentUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetConversationLogicAggregateType<
    T extends ConversationLogicAggregateArgs,
  > = {
    [P in keyof T & keyof AggregateConversationLogic]: P extends
      | '_count'
      | 'count'
      ? T[P] extends true
        ? number
  ...
  type GetConversationLogicGroupByPayload<
    T extends ConversationLogicGroupByArgs,
  > = PrismaPromise<
    Array<
      PickArray<ConversationLogicGroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof ConversationLogicGroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ? ConversationLogic & {
          [P in TrueKeys<S['include']>]: P extends 'adapter'
            ? AdapterGetPayload<S['include'][P]>
            : P extends 'bots'
            ? Array<BotGetPayload<S['include'][P]>>
            : P extends 'transformers'
            ? Array<TransformerConfigGetPayload<S['include'][P]>>
            : P extends '_count'
            ? ConversationLogicCountOutputTypeGetPayload<S['include'][P]>
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends 'adapter'
            ? AdapterGetPayload<S['select'][P]>
            : P extends 'bots'
            ? Array<BotGetPayload<S['select'][P]>>
            : P extends 'transformers'
            ? Array<TransformerConfigGetPayload<S['select'][P]>>
            : P extends '_count'
            ? ConversationLogicCountOutputTypeGetPayload<S['select'][P]>
            : P extends keyof ConversationLogic
            ? ConversationLogic[P]
            : never;
        }
      : ConversationLogic
  ...
  export interface ConversationLogicDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends ConversationLogicFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__ConversationLogicClient<ConversationLogic>,
          Prisma__ConversationLogicClient<ConversationLogicGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__ConversationLogicClient<ConversationLogic | null>,
     ...
     **/
    findFirst<
      T extends ConversationLogicFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    count<T extends ConversationLogicCountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ...
          : GetScalarType<
              T['select'],
              ConversationLogicCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends ConversationLogicAggregateArgs>(
      args: Subset<T, ConversationLogicAggregateArgs>,
    ): PrismaPromise<GetConversationLogicAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, ConversationLogicGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetConversationLogicGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
  ...
  export class Prisma__ConversationLogicClient<T> implements PrismaPromise<T> {
    ...
    adapter<T extends AdapterArgs = {}>(
      args?: Subset<T, AdapterArgs>,
    ): CheckSelect<
      T,
      Prisma__AdapterClient<Adapter | null>,
      Prisma__AdapterClient<AdapterGetPayload<T> | null>
    ...
    transformers<T extends TransformerConfigFindManyArgs = {}>(
      args?: Subset<T, TransformerConfigFindManyArgs>,
    ): CheckSelect<
      T,
      PrismaPromise<Array<TransformerConfig>>,
  ...
  export type ConversationLogicCreateArgs = {
     ...
     **/
    data: XOR<
      ConversationLogicCreateInput,
      ConversationLogicUncheckedCreateInput
    >;
  };
  ...
  export type ConversationLogicUpdateArgs = {
     ...
     **/
    data: XOR<
      ConversationLogicUpdateInput,
      ConversationLogicUncheckedUpdateInput
    >;
    /**
  ...
  export type ConversationLogicUpdateManyArgs = {
     ...
     **/
    data: XOR<
      ConversationLogicUpdateManyMutationInput,
      ConversationLogicUncheckedUpdateManyInput
    >;
    /**
  ...
  export type AdapterScalarFieldEnum =
    typeof AdapterScalarFieldEnum[keyof typeof AdapterScalarFieldEnum];
  ...
  export type TransformerScalarFieldEnum =
    typeof TransformerScalarFieldEnum[keyof typeof TransformerScalarFieldEnum];
  ...
  export type TransformerConfigScalarFieldEnum =
    typeof TransformerConfigScalarFieldEnum[keyof typeof TransformerConfigScalarFieldEnum];
  ...
  export type UserSegmentScalarFieldEnum =
    typeof UserSegmentScalarFieldEnum[keyof typeof UserSegmentScalarFieldEnum];
  ...
  export type ConversationLogicScalarFieldEnum =
    typeof ConversationLogicScalarFieldEnum[keyof typeof ConversationLogicScalarFieldEnum];
  ...
  export type TransformerConfigWhereInput = {
    ...
    ConversationLogic?: XOR<
      ConversationLogicRelationFilter,
      ConversationLogicWhereInput
    > | null;
  ...
  export type ConversationLogicCreateNestedManyWithoutAdapterInput = {
    create?: XOR<
      Enumerable<ConversationLogicCreateWithoutAdapterInput>,
      Enumerable<ConversationLogicUncheckedCreateWithoutAdapterInput>
    >;
  ...
  export type TransformerCreateNestedManyWithoutServiceInput = {
    create?: XOR<
      Enumerable<TransformerCreateWithoutServiceInput>,
      Enumerable<TransformerUncheckedCreateWithoutServiceInput>
    >;
  ...
  export type UserSegmentCreateNestedManyWithoutByIDInput = {
    create?: XOR<
      Enumerable<UserSegmentCreateWithoutByIDInput>,
      Enumerable<UserSegmentUncheckedCreateWithoutByIDInput>
    >;
  ...
  export type UserSegmentCreateNestedManyWithoutByPhoneInput = {
    create?: XOR<
      Enumerable<UserSegmentCreateWithoutByPhoneInput>,
      Enumerable<UserSegmentUncheckedCreateWithoutByPhoneInput>
    >;
  ...
  export type UserSegmentCreateNestedManyWithoutAllInput = {
    create?: XOR<
      Enumerable<UserSegmentCreateWithoutAllInput>,
      Enumerable<UserSegmentUncheckedCreateWithoutAllInput>
    >;
  ...
  export type ServiceCreateNestedOneWithoutTransformerInput = {
    create?: XOR<
      ServiceCreateWithoutTransformerInput,
      ServiceUncheckedCreateWithoutTransformerInput
    >;
  ...
  export type TransformerConfigCreateNestedManyWithoutTransformerInput = {
    create?: XOR<
      Enumerable<TransformerConfigCreateWithoutTransformerInput>,
      Enumerable<TransformerConfigUncheckedCreateWithoutTransformerInput>
    >;
  ...
  export type ServiceUpdateOneRequiredWithoutTransformerInput = {
    ...
    connect?: ServiceWhereUniqueInput;
    update?: XOR<
      ServiceUpdateWithoutTransformerInput,
      ServiceUncheckedUpdateWithoutTransformerInput
    >;
  };
  ...
  export type TransformerCreateNestedOneWithoutTranformerConfigInput = {
    create?: XOR<
      TransformerCreateWithoutTranformerConfigInput,
      TransformerUncheckedCreateWithoutTranformerConfigInput
    >;
  ...
  export type ConversationLogicCreateNestedOneWithoutTransformersInput = {
    create?: XOR<
      ConversationLogicCreateWithoutTransformersInput,
      ConversationLogicUncheckedCreateWithoutTransformersInput
    >;
  ...
  export type TransformerUpdateOneRequiredWithoutTranformerConfigInput = {
    ...
    connect?: TransformerWhereUniqueInput;
    update?: XOR<
      TransformerUpdateWithoutTranformerConfigInput,
      TransformerUncheckedUpdateWithoutTranformerConfigInput
    >;
  };
  ...
  export type ConversationLogicUpdateOneWithoutTransformersInput = {
    ...
    connect?: ConversationLogicWhereUniqueInput;
    update?: XOR<
      ConversationLogicUpdateWithoutTransformersInput,
      ConversationLogicUncheckedUpdateWithoutTransformersInput
    >;
  };

  export type UserSegmentCreateNestedManyWithoutBotsInput = {
    create?: XOR<
      Enumerable<UserSegmentCreateWithoutBotsInput>,
      Enumerable<UserSegmentUncheckedCreateWithoutBotsInput>
    >;
  ...
  export type ConversationLogicCreateNestedManyWithoutBotsInput = {
    create?: XOR<
      Enumerable<ConversationLogicCreateWithoutBotsInput>,
      Enumerable<ConversationLogicUncheckedCreateWithoutBotsInput>
    >;
  ...
  export type ServiceCreateNestedOneWithoutUserSegmentAllInput = {
    create?: XOR<
      ServiceCreateWithoutUserSegmentAllInput,
      ServiceUncheckedCreateWithoutUserSegmentAllInput
    >;
  ...
  export type ServiceCreateNestedOneWithoutUserSegmentByIDInput = {
    create?: XOR<
      ServiceCreateWithoutUserSegmentByIDInput,
      ServiceUncheckedCreateWithoutUserSegmentByIDInput
    >;
  ...
  export type ServiceCreateNestedOneWithoutUserSegmentByPhoneInput = {
    create?: XOR<
      ServiceCreateWithoutUserSegmentByPhoneInput,
      ServiceUncheckedCreateWithoutUserSegmentByPhoneInput
    >;
  ...
  export type BotCreateNestedManyWithoutUsersInput = {
    create?: XOR<
      Enumerable<BotCreateWithoutUsersInput>,
      Enumerable<BotUncheckedCreateWithoutUsersInput>
    >;
  ...
  export type ServiceUpdateOneWithoutUserSegmentAllInput = {
    ...
    connect?: ServiceWhereUniqueInput;
    update?: XOR<
      ServiceUpdateWithoutUserSegmentAllInput,
      ServiceUncheckedUpdateWithoutUserSegmentAllInput
    >;
  };
  ...
  export type ServiceUpdateOneWithoutUserSegmentByIDInput = {
    ...
    connect?: ServiceWhereUniqueInput;
    update?: XOR<
      ServiceUpdateWithoutUserSegmentByIDInput,
      ServiceUncheckedUpdateWithoutUserSegmentByIDInput
    >;
  };
  ...
  export type ServiceUpdateOneWithoutUserSegmentByPhoneInput = {
    ...
    connect?: ServiceWhereUniqueInput;
    update?: XOR<
      ServiceUpdateWithoutUserSegmentByPhoneInput,
      ServiceUncheckedUpdateWithoutUserSegmentByPhoneInput
    >;
  };
  ...
  export type AdapterCreateNestedOneWithoutConversationLogicInput = {
    create?: XOR<
      AdapterCreateWithoutConversationLogicInput,
      AdapterUncheckedCreateWithoutConversationLogicInput
    >;
  ...
  export type BotCreateNestedManyWithoutLogicIDsInput = {
    create?: XOR<
      Enumerable<BotCreateWithoutLogicIDsInput>,
      Enumerable<BotUncheckedCreateWithoutLogicIDsInput>
    >;
  ...
  export type TransformerConfigCreateNestedManyWithoutConversationLogicInput = {
    create?: XOR<
      Enumerable<TransformerConfigCreateWithoutConversationLogicInput>,
      Enumerable<TransformerConfigUncheckedCreateWithoutConversationLogicInput>
    >;
  ...
  export type AdapterUpdateOneRequiredWithoutConversationLogicInput = {
    ...
    connect?: AdapterWhereUniqueInput;
    update?: XOR<
      AdapterUpdateWithoutConversationLogicInput,
      AdapterUncheckedUpdateWithoutConversationLogicInput
    >;
  };
  ...
  export type ConversationLogicCreateOrConnectWithoutAdapterInput = {
    where: ConversationLogicWhereUniqueInput;
    create: XOR<
      ConversationLogicCreateWithoutAdapterInput,
      ConversationLogicUncheckedCreateWithoutAdapterInput
    >;
  };
  ...
  export type ConversationLogicUpsertWithWhereUniqueWithoutAdapterInput = {
    where: ConversationLogicWhereUniqueInput;
    update: XOR<
      ConversationLogicUpdateWithoutAdapterInput,
      ConversationLogicUncheckedUpdateWithoutAdapterInput
    >;
    create: XOR<
      ConversationLogicCreateWithoutAdapterInput,
      ConversationLogicUncheckedCreateWithoutAdapterInput
  ...
  export type ConversationLogicUpdateManyWithWhereWithoutAdapterInput = {
    ...
    data: XOR<
      ConversationLogicUpdateManyMutationInput,
      ConversationLogicUncheckedUpdateManyWithoutConversationLogicInput
    >;
  };
  ...
  export type TransformerCreateOrConnectWithoutServiceInput = {
    where: TransformerWhereUniqueInput;
    create: XOR<
      TransformerCreateWithoutServiceInput,
      TransformerUncheckedCreateWithoutServiceInput
    >;
  };
  ...
  export type UserSegmentCreateOrConnectWithoutByIDInput = {
    where: UserSegmentWhereUniqueInput;
    create: XOR<
      UserSegmentCreateWithoutByIDInput,
      UserSegmentUncheckedCreateWithoutByIDInput
    >;
  };
  ...
  export type UserSegmentCreateOrConnectWithoutByPhoneInput = {
    where: UserSegmentWhereUniqueInput;
    create: XOR<
      UserSegmentCreateWithoutByPhoneInput,
      UserSegmentUncheckedCreateWithoutByPhoneInput
    >;
  };
  ...
  export type UserSegmentCreateOrConnectWithoutAllInput = {
    where: UserSegmentWhereUniqueInput;
    create: XOR<
      UserSegmentCreateWithoutAllInput,
      UserSegmentUncheckedCreateWithoutAllInput
    >;
  };
  ...
  export type TransformerUpsertWithWhereUniqueWithoutServiceInput = {
    where: TransformerWhereUniqueInput;
    update: XOR<
      TransformerUpdateWithoutServiceInput,
      TransformerUncheckedUpdateWithoutServiceInput
    >;
    create: XOR<
      TransformerCreateWithoutServiceInput,
      TransformerUncheckedCreateWithoutServiceInput
  ...
  export type TransformerUpdateManyWithWhereWithoutServiceInput = {
    ...
    data: XOR<
      TransformerUpdateManyMutationInput,
      TransformerUncheckedUpdateManyWithoutTransformerInput
    >;
  };
  ...
  export type UserSegmentUpsertWithWhereUniqueWithoutByIDInput = {
    where: UserSegmentWhereUniqueInput;
    update: XOR<
      UserSegmentUpdateWithoutByIDInput,
      UserSegmentUncheckedUpdateWithoutByIDInput
    >;
    create: XOR<
      UserSegmentCreateWithoutByIDInput,
      UserSegmentUncheckedCreateWithoutByIDInput
  ...
  export type UserSegmentUpdateManyWithWhereWithoutByIDInput = {
    ...
    data: XOR<
      UserSegmentUpdateManyMutationInput,
      UserSegmentUncheckedUpdateManyWithoutUserSegmentByIDInput
    >;
  };
  ...
  export type UserSegmentUpsertWithWhereUniqueWithoutByPhoneInput = {
    where: UserSegmentWhereUniqueInput;
    update: XOR<
      UserSegmentUpdateWithoutByPhoneInput,
      UserSegmentUncheckedUpdateWithoutByPhoneInput
    >;
    create: XOR<
      UserSegmentCreateWithoutByPhoneInput,
      UserSegmentUncheckedCreateWithoutByPhoneInput
  ...
  export type UserSegmentUpdateManyWithWhereWithoutByPhoneInput = {
    ...
    data: XOR<
      UserSegmentUpdateManyMutationInput,
      UserSegmentUncheckedUpdateManyWithoutUserSegmentByPhoneInput
    >;
  };
  ...
  export type UserSegmentUpsertWithWhereUniqueWithoutAllInput = {
    where: UserSegmentWhereUniqueInput;
    update: XOR<
      UserSegmentUpdateWithoutAllInput,
      UserSegmentUncheckedUpdateWithoutAllInput
    >;
    create: XOR<
      UserSegmentCreateWithoutAllInput,
      UserSegmentUncheckedCreateWithoutAllInput
  ...
  export type UserSegmentUpdateManyWithWhereWithoutAllInput = {
    ...
    data: XOR<
      UserSegmentUpdateManyMutationInput,
      UserSegmentUncheckedUpdateManyWithoutUserSegmentAllInput
    >;
  };
  ...
  export type TransformerConfigCreateOrConnectWithoutTransformerInput = {
    where: TransformerConfigWhereUniqueInput;
    create: XOR<
      TransformerConfigCreateWithoutTransformerInput,
      TransformerConfigUncheckedCreateWithoutTransformerInput
    >;
  };
  ...
  export type TransformerConfigUpsertWithWhereUniqueWithoutTransformerInput = {
    where: TransformerConfigWhereUniqueInput;
    update: XOR<
      TransformerConfigUpdateWithoutTransformerInput,
      TransformerConfigUncheckedUpdateWithoutTransformerInput
    >;
    create: XOR<
      TransformerConfigCreateWithoutTransformerInput,
      TransformerConfigUncheckedCreateWithoutTransformerInput
  ...
  export type TransformerConfigUpdateManyWithWhereWithoutTransformerInput = {
    ...
    data: XOR<
      TransformerConfigUpdateManyMutationInput,
      TransformerConfigUncheckedUpdateManyWithoutTranformerConfigInput
    >;
  };
  ...
  export type UserSegmentCreateOrConnectWithoutBotsInput = {
    where: UserSegmentWhereUniqueInput;
    create: XOR<
      UserSegmentCreateWithoutBotsInput,
      UserSegmentUncheckedCreateWithoutBotsInput
    >;
  };
  ...
  export type ConversationLogicCreateOrConnectWithoutBotsInput = {
    where: ConversationLogicWhereUniqueInput;
    create: XOR<
      ConversationLogicCreateWithoutBotsInput,
      ConversationLogicUncheckedCreateWithoutBotsInput
    >;
  };
  ...
  export type UserSegmentUpsertWithWhereUniqueWithoutBotsInput = {
    where: UserSegmentWhereUniqueInput;
    update: XOR<
      UserSegmentUpdateWithoutBotsInput,
      UserSegmentUncheckedUpdateWithoutBotsInput
    >;
    create: XOR<
      UserSegmentCreateWithoutBotsInput,
      UserSegmentUncheckedCreateWithoutBotsInput
  ...
  export type UserSegmentUpdateManyWithWhereWithoutBotsInput = {
    ...
    data: XOR<
      UserSegmentUpdateManyMutationInput,
      UserSegmentUncheckedUpdateManyWithoutUsersInput
    >;
  };
  ...
  export type ConversationLogicUpsertWithWhereUniqueWithoutBotsInput = {
    where: ConversationLogicWhereUniqueInput;
    update: XOR<
      ConversationLogicUpdateWithoutBotsInput,
      ConversationLogicUncheckedUpdateWithoutBotsInput
    >;
    create: XOR<
      ConversationLogicCreateWithoutBotsInput,
      ConversationLogicUncheckedCreateWithoutBotsInput
  ...
  export type ConversationLogicUpdateManyWithWhereWithoutBotsInput = {
    ...
    data: XOR<
      ConversationLogicUpdateManyMutationInput,
      ConversationLogicUncheckedUpdateManyWithoutLogicIDsInput
    >;
  };
  ...
  export type BotCreateOrConnectWithoutUsersInput = {
    where: BotWhereUniqueInput;
    create: XOR<
      BotCreateWithoutUsersInput,
      BotUncheckedCreateWithoutUsersInput
    >;
  };
  ...
  export type BotUpsertWithWhereUniqueWithoutUsersInput = {
    where: BotWhereUniqueInput;
    update: XOR<
      BotUpdateWithoutUsersInput,
      BotUncheckedUpdateWithoutUsersInput
    >;
    create: XOR<
      BotCreateWithoutUsersInput,
      BotUncheckedCreateWithoutUsersInput
  ...
  export type BotUpdateManyWithWhereWithoutUsersInput = {
    ...
    data: XOR<
      ...
      BotUncheckedUpdateManyWithoutBotsInput
    >;
  };
  ...
  export type BotCreateOrConnectWithoutLogicIDsInput = {
    where: BotWhereUniqueInput;
    create: XOR<
      BotCreateWithoutLogicIDsInput,
      BotUncheckedCreateWithoutLogicIDsInput
    >;
  };
  ...
  export type TransformerConfigCreateOrConnectWithoutConversationLogicInput = {
    where: TransformerConfigWhereUniqueInput;
    create: XOR<
      TransformerConfigCreateWithoutConversationLogicInput,
      TransformerConfigUncheckedCreateWithoutConversationLogicInput
    >;
  };
  ...
  export type BotUpsertWithWhereUniqueWithoutLogicIDsInput = {
    where: BotWhereUniqueInput;
    update: XOR<
      BotUpdateWithoutLogicIDsInput,
      BotUncheckedUpdateWithoutLogicIDsInput
    >;
    create: XOR<
      BotCreateWithoutLogicIDsInput,
      BotUncheckedCreateWithoutLogicIDsInput
  ...
  export type TransformerConfigUpsertWithWhereUniqueWithoutConversationLogicInput =
    {
      where: TransformerConfigWhereUniqueInput;
      update: XOR<
        TransformerConfigUpdateWithoutConversationLogicInput,
        TransformerConfigUncheckedUpdateWithoutConversationLogicInput
      >;
      create: XOR<
        TransformerConfigCreateWithoutConversationLogicInput,
        TransformerConfigUncheckedCreateWithoutConversationLogicInput
  ...
  export type TransformerConfigUpdateManyWithWhereWithoutConversationLogicInput =
    {
      ...
      data: XOR<
        TransformerConfigUpdateManyMutationInput,
        TransformerConfigUncheckedUpdateManyWithoutTransformersInput
      >;
    };
