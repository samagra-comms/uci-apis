...
export class ConversationLogicController {
  constructor(private readonly conversationLogicService: ConversationLogicService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateConversationLogicDto: UpdateConversationLogicDto) {
